class FundoImobiliario:
    def __init__(self, codigo, segmento, cotacao_atual, ffo_yield, dividend_yield, p_vp,
...
class Estrategia:
    def __init__(self, segmento="", cotacao_atual_minima=0, ffo_yield_minimo=0, dividend_yield_minimo=0,
                 p_vp_minimo=0, valor_mercado_minimo=0, liquidez_minima=0, qt_imoveis_minima=0,
                 valor_minimo_preco_m2_=0, valor_minimo_aluguel_m2=0, valor_minimo_cap_rate=0,
        ...
        self.valor_minimo_preco_m2_ = valor_minimo_preco_m2_
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.preco_m2 < self.valor_minimo_preco_m2_ \
